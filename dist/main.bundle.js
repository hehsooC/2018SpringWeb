...
var GameComponent = /** @class */ (function () {
    ...
    function GameComponent(http) {
        ...
        http.get(this._api + "/quotes").subscribe(function (data) { return _this.Me.MyQuotes = data.json(); }); // get quotes, when getting quote, store it to data
